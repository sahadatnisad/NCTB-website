...
function nctb_theme_enqueue_assets() {
	...
	// Site-wide UI controls: language toggle + dark mode (loads everywhere).
	wp_enqueue_style(
		'nctb-theme-ui',
		get_stylesheet_directory_uri() . '/css/theme-ui.css',
		array( 'nctb-theme' ),
		wp_get_theme()->get( 'Version' )
	);
	wp_enqueue_script(
		'nctb-theme-ui',
		get_stylesheet_directory_uri() . '/js/theme-ui.js',
		array(),
		wp_get_theme()->get( 'Version' ),
		true
	);
	...
	if ( is_singular( array( 'nctb_book', 'nctb_unit', 'nctb_lesson' ) ) || is_post_type_archive( 'nctb_book' ) || is_page( array( 'mistakes', 'revision', 'progress', 'dashboard', 'purchases', 'board-questions', 'board-analytics' ) ) ) {
		wp_enqueue_style(
			'nctb-curriculum',
	...
	if ( is_singular( 'nctb_lesson' ) || is_page( array( 'mistakes', 'revision', 'progress', 'dashboard', 'purchases', 'board-questions', 'board-analytics' ) ) ) {
		wp_enqueue_script(
